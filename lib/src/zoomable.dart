...
class ZoomableAdvancedWidget extends StatefulWidget {
  ZoomableAdvancedWidget({
    Key key,
    this.minScale: 0.7,
    this.maxScale: 1.4,
  ...
  @override
  _ZoomableAdvancedWidgetState createState() => _ZoomableAdvancedWidgetState();
}

class _ZoomableAdvancedWidgetState extends State<ZoomableAdvancedWidget> {
